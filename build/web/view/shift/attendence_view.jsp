 ...
 function getPdf(){
    ...
    <body>
        ...
        <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
            ...
            <td align="center" id="t1c${IDGenerator.uniqueID}"  >${ShiftLoginModel.attendence}</td>
            <td id="t1c${IDGenerator.uniqueID}"  >${ShiftLoginModel.start_time}</td>
            <td id="t1c${IDGenerator.uniqueID}"  >${ShiftLoginModel.end_time}</td>
