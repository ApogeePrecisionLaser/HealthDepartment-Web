    ...
    function fillColumns(id)
     {
        ...
        document.getElementById("vehicle_code").value = document.getElementById(t1id +(lowerLimit+17)).innerHTML;
        changeStatus();
...
function setStatus(id) {
 ...
 <form name="form1" action="ShiftKeyPersonMapController">
        ...
        <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
                ...
                <TH class="heading" style="white-space: normal">Shift Type&nbsp;</TH>
                 <th class="heading" style="white-space: normal">Designation&nbsp;</th>
                 <TH class="heading" style="white-space: normal">Location Type&nbsp;</TH>
                 <TH class="heading" style="white-space: normal">Zone Name&nbsp;</TH>
                 <TH class="heading" style="white-space: normal">Ward Name&nbsp;</TH>
                 <TH class="heading" style="white-space: normal">Area Name&nbsp;</TH>
                <TH class="heading" style="white-space: normal">City Location Name&nbsp;</TH>
                <th class="heading" style="white-space: normal">Person Name&nbsp;</th>
                <th class="heading" style="white-space: normal">Date&nbsp;</th>
                <th class="heading" style="white-space: normal">Remark&nbsp;</th>
                <th class="heading" style="white-space: normal">Vehicle Code&nbsp;</th>
            ...
            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${ShiftKeyPersonMapModel.vehicle_code}</td>
            </tr>
            </TR>
                          ...
                          <table  align="center" class="content" border="1">
                             ...
                             <tr>
                              ...
                              <select name="location_type" id="location_type" onchange="changeStatus()" disabled>
                               ...
                               <td id="vehicle" ><input type="text" class="new_input"  id="vehicle_code" name="vehicle_code" value="" ></td>
                             </tr>
                                    <tr>
