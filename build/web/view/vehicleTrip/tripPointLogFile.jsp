...
<html>
    <head>
        ...
        <script type="text/javascript">
            jQuery(function(){
                $("#searchTime").autocomplete("TripPointLogFileCont.do", {
                    extraParams: {
                        action1: function() { return "getTime" }
                    }
                });
                $("#searchRoute").autocomplete("TripPointLogFileCont.do", {
                    extraParams: {
                        action1: function() { return "getRoute" }
                    }
                });
//                $("#searchDay").autocomplete("tripStopageCont.do", {
//                    extraParams: {
//                        action1: function() { return "getWeek" }
//                    }
//                });
//                $("#route_name").autocomplete("tripStopageCont.do", {
//                    extraParams: {
//                        action1: function() { return "getRoute" }
//                    }
//                });
//                $("#stopage_name").autocomplete("tripStopageCont.do", {
//                    extraParams: {
...
//                });
            ...
            function getWeekDays(route){
                $.ajax({url: "tripStopageCont.do",data: "action1=getTripDay&route=" +route.replace('&', '-'), success: function(response_data){
            ...
            function getTripStartTime(day){
                $.ajax({url: "tripStopageCont.do",data: "action1=getTripTime&day=" +day, success: function(response_data){
                        var responseArray = response_data.split("##");
                        var length = responseArray.length;
                        $("#start_time").html("");
                        if(length == 1){
            ...
            function getStopageName(){
                $.ajax({url: "tripStopageCont.do",data: "action1=getStopageName&trip_id=" +$("#start_time").val(), success: function(response_data){
            ...
            function fillColumns(id) {
                ...
                var start_time = document.getElementById(t1id +(lowerLimit+7)).innerHTML;
                ...
                setStartingTime(document.getElementById(t1id +(lowerLimit+8)).innerHTML);
                setEndingTime(document.getElementById(t1id +(lowerLimit+9)).innerHTML);
            ...
            function viewMap(lattitude,longitude) {
                ...
                var url="TripPointLogFileCont.do?task=showMapWindow&logitude="+y+"&lattitude="+x;
            ...
            function displayRouteList(id){
                ...
                var url = "TripPointLogFileCont.do?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Trip Point Log File</b></td>
                                    </tr>
                                </table>
                            </td></tr>
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="TripPointLogFileCont.do">
                                        <table align="center" class="heading1" width="700">
                                            ...
                                            <tr>
                                                ...
                                                <th>start time</th>
                                                <td><input class="input " type="text" id="searchTime" name="searchTime" value="${searchTime}" size="10" ></td>
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        <form name="form1" action="TripPointLogFileCont.do">
                                            ...
                                            <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
                                                ...
                                                <c:forEach var="rideAppBean" items="${requestScope['list']}"  varStatus="loopCounter">
                                                    <c:if test="${rideAppBean.trip_id ne id }">
                                                        <c:set var="id" value="${rideAppBean.trip_id}"/>
                                                        <tr align="center">
                                                            <th class="heading">S.No.</th>
                                                            <th  class="heading" colspan="4">Route Name</th>
                                                            <th  class="heading" colspan="2">Start Time</th>
                                                        </tr>
                                                        <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" align=center"">
                                                            ...
                                                            <td id="t1c${IDGenerator.uniqueID}" class=""  onclick="fillColumns(id)" colspan="4" align="center">${rideAppBean.route_name}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)" colspan="2">${rideAppBean.start_time}</td>
                                                        </tr>
                                                        <tr>
                                                            <th  class="heading">Point name</th>
                                                            <th  class="heading" style="white-space: normal"> Schedule Arrival Time</th>
                                                            <th  class="heading" style="white-space: normal"> Schedule Departure Time </th>
                                                            <th  class="heading" style="white-space: normal"> Actual Arrival Time</th>
                                                            <th  class="heading" style="white-space: normal"> Actual Departure Time </th>
                                                            <th class="heading"></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)" >${rideAppBean.arrival_time_a}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumns(id)" >${rideAppBean.departure_time_a}</td>
                                                        <td>
                                    ...
                                    <form  action="TripPointLogFileCont.do" method="post" onsubmit="return verify()" style="display: none">
...
<!--                                        <table  align="center"  class="content" cellpadding="2%" border="1">
                                            ...
                                            <tr>
                                                <td colspan="4" align="center">
                                                    <span class="heading1"> Stoppage Name </span>
                                                    <input class="input new_input" type="text"  id="stopage_name" size="15" name="stopage_name" value="" disabled>
