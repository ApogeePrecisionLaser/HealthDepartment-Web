...
var designation=document.getElementById(t1id +(lowerLimit+3)).innerHTML;
var location_type=document.getElementById(t1id +(lowerLimit+4)).innerHTML;
var zone_name=document.getElementById(t1id +(lowerLimit+5)).innerHTML;
var ward_name=document.getElementById(t1id +(lowerLimit+7)).innerHTML;
var area_name=document.getElementById(t1id +(lowerLimit+9)).innerHTML;
//alert(designation+"2 "+location_type+"3 "+zone_name+"4 "+ward_name+"5 "+area_name);
       getTypeOfErrorList(designation,location_type,zone_name,ward_name,area_name);
    }
    function getTypeOfErrorList(designation,location_type,zone_name,ward_name,area_name){
                var queryString = "task=showInfo&designation="+designation+"&location_type="+location_type+"&zone_name="+zone_name+"&ward_name="+ward_name+"&area_name="+area_name;
                var url = "ShiftKeyPersonMISController?"+queryString;
