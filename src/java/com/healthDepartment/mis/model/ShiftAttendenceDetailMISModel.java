...
import com.healthDepartment.mis.tableClasses.ShiftAttendenceDetailMIS;
 ...
 * @author Shobha
 */
public class ShiftAttendenceDetailMISModel {
 private static Connection connection;
   ...
   public  int  getNoOfRows(String date)
 {        int noOfRows = 0;
 ...
 public  List<ShiftAttendenceDetailMIS> showData(String date)
    {
          if(date != null && !date.isEmpty()){
            String[] date_array  = date.split("-");
            date = date_array[2] + "-" + date_array[1] + "-" + date_array[0];
     ...
     String query = "select a.attendence_id,kp.emp_code,kp.key_person_name,kp.mobile_no1,a.attendence from shift_key_person_map as skpm,key_person as kp,attendence a "
      ...
      try {
            ResultSet rs = connection.prepareStatement(query).executeQuery();
             while(rs.next()){
                  ShiftAttendenceDetailMIS sb=new ShiftAttendenceDetailMIS();
 ...
 public static List<ShiftAttendenceDetailMIS> showAttendenceData(int lowerLimit,int noOfRowsToDisplay,String empcode,String mobileno,String sdate,String searchemp,String attendence)
    {
     searchemp = krutiToUnicode.convert_to_unicode(searchemp);
             if(sdate != null && !sdate.isEmpty()){
                   String[] sdate_array  = sdate.split("-");
 ...
 public  boolean updateRecord(ShiftAttendenceDetailMIS bean)
   {
