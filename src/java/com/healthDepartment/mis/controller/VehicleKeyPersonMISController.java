...
import com.healthDepartment.mis.model.VehicleKeyPersonMISModel;
 ...
 * @author Shobha
 */
public class VehicleKeyPersonMISController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        //PrintWriter out = response.getWriter();
         ...
         VehicleKeyPersonMISModel vkpm=new VehicleKeyPersonMISModel();
  ...
  String  vehicle=request.getParameter("search_vehicle_code");
      ...
      try{
          ...
          try{
             if (task.equals("generateHSReport"))
           {
              ...
              li=vkpm.showData(-1,-1,vehicle,key_person_name);
    ...
    if (buttonAction.equals("Next"));
     ...
     if (task.equals("save") || task.equals("Save AS New") ||  task.equals("Delete")) {
         ...
         List<VehicleKeyPersonMIS>  list=  vkpm.showData(lowerLimit, noOfRowsToDisplay,vehicle,key_person_name);
        ...
        request.setAttribute("message", vkpm.getMessage());
            ...
            RequestDispatcher rd=request.getRequestDispatcher("vehicleKeyPersonMIS");
