...
import com.healthDepartment.mis.model.ShiftAttendenceDetailMISModel;
 ...
 * @author Shobha
 */
public class ShiftAttendenceDetailMISController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(task==null)
         ...
         ServletContext ctx = getServletContext();
          ShiftAttendenceDetailMISModel am=new ShiftAttendenceDetailMISModel();
  ...
  if (task.equals("Show All Records")) {
       ...
       if (task.equals("save") || task.equals("Save AS New") || task.equals("Revised") || task.equals("Delete") ) {
         ...
         List<ShiftAttendenceDetailMIS>  list=  am.showAttendenceData(lowerLimit,noOfRowsToDisplay,empcode, mobileno,date,searchemp,attendence);
         ...
         request.setAttribute("IDGenerator", new UniqueIDGenerator());
            RequestDispatcher rd=request.getRequestDispatcher("attendenceviewMIS");
