 ...
 * @author Shobha
 */
public class TripPointLogFileBean {
 private int trip_id;
    ...
    private String arrival_time_a;
    private String departure_time_a;
    private String start_time;
    private String route_name;
    private String location_code;

    public String getArrival_time_a() {
        return arrival_time_a;
    }

    public void setArrival_time_a(String arrival_time_a) {
        this.arrival_time_a = arrival_time_a;
    }

    public String getDeparture_time_a() {
        return departure_time_a;
    }

    public void setDeparture_time_a(String departure_time_a) {
        this.departure_time_a = departure_time_a;
    }
