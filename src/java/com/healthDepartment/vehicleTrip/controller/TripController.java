...
import com.healthDepartment.vehicleTrip.model.TripModel;
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (requester != null && requester.equals("PRINT")) {
                ...
                List<TripBean> mainList = sm.showData(-1, -1, searchRoute, searchDay, searchTime);
                jrxmlFilePath = ctx.getRealPath("/report/vehicleTrip/trip.jrxml");
                ...
                ServletOutputStream servletOutputStream = response.getOutputStream();
                List<TripBean> mainList = sm.showData(-1, -1, searchRoute, searchDay, searchTime);
                jrxmlFilePath = ctx.getRealPath("/report/vehicleTrip/trip.jrxml"); // organisationlist.jrxml
            ...
            List<TripBean> list = sm.showData(lowerLimit, noOfRowsToDisplay, searchRoute, searchDay, searchTime);
            ...
            RequestDispatcher rd = request.getRequestDispatcher("trip");
