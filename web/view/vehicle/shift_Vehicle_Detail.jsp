...
<html>
    <head>
        ...
        <script type="text/javascript">
            jQuery(function(){
                $("#search_given_by").autocomplete("ShiftVehicleDetail", {
                    extraParams: {
            ...
            jQuery(function(){
                $("#search_taken_by").autocomplete("ShiftVehicleDetail", {
                    extraParams: {
            ...
            //         });
            jQuery(function(){
                $("#vehicle_code").autocomplete("ShiftVehicleDetail", {
                    extraParams: {
            ...
            jQuery(function(){
                $("#vehicle_number").autocomplete("ShiftVehicleDetail", {
                    extraParams: {
            ...
            jQuery(function(){
                $("#point").autocomplete("ShiftVehicleDetail", {
                    extraParams: {
                ...
                $("#vehicle_code").result(function(event, data, formatted){
                    ...
                    $.ajax({url: "ShiftVehicleDetail?action1=getZone&temp="+temp, data: "action3="+ data +"&q=", success: function(response_data) {
         ...
         $("#search_date").datepicker({
            ...
            jQuery(function(){
                $("#given_by").autocomplete("ShiftVehicleDetail", {
                    extraParams: {
            ...
            jQuery(function(){
                $("#taken_by").autocomplete("ShiftVehicleDetail", {
                    extraParams: {
            ...
            function openMap(shiftVehicleDetailId) {
        //alert(vehicle_key_person_map_id);
        var url="ShiftVehicleDetail?task=showMapWindow&shiftVehicleDetailId="+shiftVehicleDetailId;
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <form name="form0" action="ShiftVehicleDetail">
                     ...
                     <th>Date</th>
                        ...
                        <form name="form1" action="ShiftVehicleDetail">
                            ...
                            <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
                                ...
                                <c:forEach var="shiftVehicleDetail" items="${requestScope['list']}" varStatus="loopCounter">
                                    <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                    <tr>
                                        <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)"> ${shiftVehicleDetail.shiftVehicleDetailId}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" align="center"> ${lowerLimit + loopCounter.count- noOfRowsTraversed }</td>
                                        <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)">${shiftVehicleDetail.givenBy}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"  class="new_input"  onclick="fillColumns(id)">${shiftVehicleDetail.takenBy}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"  class="new_input"  onclick="fillColumns(id)">${shiftVehicleDetail.vehicleCode}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"  class="new_input"  onclick="fillColumns(id)">${shiftVehicleDetail.point_name}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"    onclick="fillColumns(id)">${shiftVehicleDetail.date}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"    onclick="fillColumns(id)">${shiftVehicleDetail.status}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"    onclick="fillColumns(id)">${shiftVehicleDetail.latitude}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"    onclick="fillColumns(id)">${shiftVehicleDetail.longitude}</td>
                                        <td id="t1c${IDGenerator.uniqueID}"  style="display: none" class="new_input"  onclick="fillColumns(id)">${shiftVehicleDetail.vehicleNumber}</td>
                                        <td>
              <input type="button" class="btn"  value ="View Map" id="map_container${loopCounter.count}" onclick="openMap('${shiftVehicleDetail.shiftVehicleDetailId}');"/>
              </td>
                                    </tr>
                                    </TR>
                                </c:forEach>
                        ...
                        <form  action="ShiftVehicleDetail" method="post">
                            ...
                            <table  align="center"  class="content" cellpadding="2%" border="1">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="new_input" id="given_by" size="19" name="given_by" value=""  disabled></td>
                                    <th class="heading1">Taken by</th>
                                    <td><input type="text" class="new_input" id="taken_by" size="19" name="taken_by" value=""  disabled></td>

                                </tr>
                                <tr>

                                    <th class="heading1"> Vehicle given by </th>
                                    <td>Code<input type="text" class="new_input" id="vehicle_code" size="10" name="vehicle_code" value=""  disabled>
                                        No<input type="text" class="new_input" id="vehicle_number" size="10" name="vehicle_number" value=""  disabled></td>

                                </tr>
                                <tr>

                                    <th class="heading1"> Point </th>
                                    <td><input type="text" class="new_input" id="point" size="19" name="point" value=""  disabled></td>
                                    <th class="heading1"> Status </th>
                                    <td><input type="text" class="new_input" id="status" size="19" name="status" value="फुल"  disabled></td>
                                </tr>
                                <tr>

                                    <th class="heading1"> Date </th>
                                    <td><input type="text"  id="date" size="19" name="date" value=""  disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"  id="longitude" size="19" name="longitude" value=""  disabled><input style="margin-left:18px;" class="button" type="button" id="get_cordinate" value="Get Cordinate" onclick="openMapForCord()" disabled></td>
                                </tr>
