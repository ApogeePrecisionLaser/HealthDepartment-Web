...
<html>
    <head>
        ...
        jQuery(function(){
               ...
               extraParams: {
               action1: function() { return "getsearch_key_person_name"}
             }
            });
         });
          jQuery(function(){
...
//        }
        ...
        //$("#message").html("");
        var vehicle_key_person_id= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        var key_person_name=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
        var vehicle_code=document.getElementById(t1id + (lowerLimit + 3)).innerHTML;
        getTypeOfErrorList(vehicle_key_person_id,key_person_name,vehicle_code);
    }


     function getTypeOfErrorList(vehicle_key_person_id,key_person_name,vehicle_code){
                var queryString = "task=showVehicleKPPointMISInfo&vehicle_key_person_id="+vehicle_key_person_id+"&key_person_name="+key_person_name+"&vehicle_code="+vehicle_code;
                var url = "VehicleKeyPersonPointMIS?"+queryString;
...
function setStatus(id) {
    ...
    function getVehicleKeyPerson(){
               ...
               // var mobileNo = $("#mobileNo").val();
                ...
                var url = "VehicleKeyPersonController?" + queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Vehicle Key_Person</b></td>
                                    </tr>
                                </table>
                            </td></tr>
