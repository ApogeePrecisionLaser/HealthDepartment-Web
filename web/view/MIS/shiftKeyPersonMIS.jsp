...
//        $("#message").html("");
    ...
    var person_name=document.getElementById(t1id +(lowerLimit+13)).innerHTML;
    var date=document.getElementById(t1id +(lowerLimit+15)).innerHTML;
    getTypeOfErrorList(person_name,date);

    }
    function getTypeOfErrorList(person_name,date){
                var queryString = "task=shiftBenificiaryMISInfo&person_name="+person_name+"&date="+date;
                var url = "ShiftBenificiaryDetailMISController?"+queryString;
