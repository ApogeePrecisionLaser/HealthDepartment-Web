...
<script type="text/javascript">
           ...
           /*$("#week_days").autocomplete("tripCont.do",{
            extraParams:
               ...
               $("#searchVehicleCode").autocomplete("TripLogFileCont.do",{
            extraParams: {
                action1: function() { return "getVehicleCode" }
                }
              });
               $("#searchTripName").autocomplete("TripLogFileCont.do",
           {
            extraParams:
                {
                action1: function() { return "getTripName" }
                }
              });
    ...
    $("#week_days").result(function(event, data, formatted) {debugger;
          ...
          var day = data;
         $.ajax({url: "TripLogFileCont.do",data: "task=getTime&day=" +day, success: function(response_data){
                 alert(response_data);
  ...
  function myLeftTrim(str) {
    ...
    function openPopUp(url, window_name, popup_height, popup_width) {
     ...
     function displayRouteList(id){
                ...
                var url = "TripLogFileCont.do?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Trip Log File</b></td>
                                    </tr>
                                </table>
                            </td></tr>
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="TripLogFileCont.do">
                                        <table align="center" class="heading1" width="700">
                                            <tr>
                                                <th>Trip Name</th>
                                                <td><input class="input" type="text" id="searchTripName" name="searchTripName" value="${searchTripName}" size="30" ></td>

                                                <th>Vehicle code</th>
                                                <td><input class="input " type="text" id="searchVehicleCode" name="searchVehicleCode" value="${searchVehicleCode}" size="30" ></td>
                                            </tr><tr>
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        <form name="form1" action="TripLogFileCont.do">
                                            ...
                                            <TABLE BORDER="1" align="center" cellpadding="5%" width="52%" class="content">
                                                ...
                                                <tr>
                                                    ...
                                                    <th  class="heading">Start Location</th>
                                                    <th  class="heading">End Location</th>
                                                ...
                                                <c:forEach var="rideAppBean" items="${requestScope['list']}"  varStatus="loopCounter">
                                                    <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" style="display:none" > ${rideAppBean.trip_log_file_id}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}"  align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" >${rideAppBean.trip_name}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" >${rideAppBean.vehicle_code}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" >${rideAppBean.date}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" >${rideAppBean.start_time}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" >${rideAppBean.end_time}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" >${rideAppBean.start_location}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" >${rideAppBean.end_location}</td>
                                    ...
                                    <br>
                                    <br>
                                    <form  action="TripLogFileCont.do" method="post" onsubmit="return verify()">
